...
namespace IdentityLearning.Infrastructure.Repositories
{
    internal class EmailSender : IEmailSender
    {
        ...
        public EmailSender(IOptions<EmailServiceOptions> emailHandlerOptions, ILogger<EmailSender> logger)
        {
            _logger = logger;
        ...
        public void SendEmailConfirmationMessage(string toEmail, string code, long userId)
        {
            Task.Run(async () =>
            {
                ...
                _logger.LogInformation($"Email confirmation for user with id: {userId} and code: {code} was sent");
        ...
        public void SendDeleteAccountConfirmationMessage(string toEmail, string code, long userId)
        {
             Task.Run(async () =>
            {
                var url = _emailServiceOptions.DeleteAccountConfirmationUrl +
                          $"?userId={userId}&code={HttpUtility.UrlEncode(code)}";
                ...
                message.Subject = "Confirm delete of your account";
                message.Body = new TextPart(TextFormat.Html)
                {
                    Text = $"<!DOCTYPE html>\r\n<html lang=\"en\">\r\n\r\n<head>\r\n  <meta charset=\"UTF-8\">\r\n  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\r\n\r\n  <style>\r\n    .bg {{\r\n      background-color: #323232;\r\n      padding-top: 20px;\r\n      padding-left: 10px;\r\n      padding-right: 10px;\r\n      height: 500px;\r\n    }}\r\n\r\n    .downBg {{\r\n      background-color: #686868;\r\n      padding: 10px;\r\n    }}\r\n\r\n    .icon {{\r\n      font-size: 15px;\r\n      float: right;\r\n      font-weight: 800;\r\n      font-family: Verdana, Geneva, Tahoma, sans-serif;\r\n      color: #fff;\r\n    }}\r\n\r\n    .dev {{\r\n      font-size: 15px;\r\n      text-align: left;\r\n      display: inline-block;\r\n      font-weight: 400;\r\n      font-family: Verdana, Geneva, Tahoma, sans-serif;\r\n      color: #fff;\r\n    }}\r\n\r\n    .ignore {{\r\n      margin-top: 20px;\r\n      font-size: 14px;\r\n      text-align: center;\r\n      display: block;\r\n      font-weight: 400;\r\n      font-family: Verdana, Geneva, Tahoma, sans-serif;\r\n      color: #d8d8d8;\r\n    }}\r\n\r\n    .project {{\r\n      font-size: 27px;\r\n      text-align: center;\r\n      font-weight: 800;\r\n      font-family: Verdana, Geneva, Tahoma, sans-serif;\r\n      color: #fff;\r\n    }}\r\n\r\n    .button {{\r\n      font-size: 16px;\r\n      font-weight: 700;\r\n      padding: 15px 40px;\r\n      color: #fff;\r\n      background-color: #ff2525;\r\n      border-color: #ff0b0b;\r\n      text-decoration: none;\r\n      display: block;\r\n      text-align: center;\r\n      margin-top: 30px;\r\n      background-image: none;\r\n      font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;\r\n      border: 1px solid transparent;\r\n      white-space: nowrap;\r\n      line-height: 2;\r\n      border-radius: 16px;\r\n    }}\r\n  </style>\r\n\r\n</head>\r\n\r\n<body>\r\n  <div class=\"bg\">\r\n    <h2 class=\"project\">\r\n      IdentityLearning\r\n    </h2>\r\n    <a href=\"{url}\" class=\"button\">\r\n      <b style=\"color: white;\">\r\n        Confirm delete of your account\r\n      </b>\r\n    </a>\r\n    <p class=\"ignore\">\r\n      If you don't want to delete your account, ignore this message\r\n    </p>\r\n\r\n  </div>\r\n  <div class=\"downBg\">\r\n    <p class=\"dev\">\r\n      ControlDev\r\n    </p>\r\n\r\n    <p class=\"icon\">\r\n      ^_^\r\n    </p>\r\n  </div>\r\n\r\n</body>\r\n\r\n</html>"
                };
                ...
                _logger.LogInformation($"Delete confirmation for user with id: {userId} and code: {code} was sent");
                await client.SendAsync(message);
