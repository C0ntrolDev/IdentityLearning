...
using IdentityLearning.Application.Features.Acccount.Commands.ConfirmDeleteUser;
using IdentityLearning.Application.Features.Acccount.Commands.ConfirmEmail;
using IdentityLearning.Application.Features.Acccount.Commands.DeleteUser;
using IdentityLearning.Application.Features.Acccount.Commands.Login;
using IdentityLearning.Application.Features.Acccount.Commands.Register;
using IdentityLearning.Application.Features.Acccount.Commands.UpdatePassword;
using IdentityLearning.Application.Features.Acccount.Commands.UpdateProfile;
using IdentityLearning.Application.Features.Acccount.Queries.GetProfile;
